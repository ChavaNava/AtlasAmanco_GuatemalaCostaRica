...
Public Class rptCCEXProdDet_AMEX
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCCEXProdDet_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Atlas.rptCCEXProdDet_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCCEXProdDet_AMEX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCCEXProdDet_AMEX = New rptCCEXProdDet_AMEX()
        rpt.Site = Me.Site
        Return rpt
    End Function
