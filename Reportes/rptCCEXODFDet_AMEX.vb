...
Public Class rptCCEXODFDet_AMEX
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Atlas.rptCCEXODFDet_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCCEXODFDet_AMEX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCCEXODFDet_AMEX = New rptCCEXODFDet_AMEX()
        rpt.Site = Me.Site
        Return rpt
    End Function
