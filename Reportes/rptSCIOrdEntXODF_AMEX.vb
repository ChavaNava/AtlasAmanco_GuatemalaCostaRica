...
Public Class rptSCIOrdEntXODF_AMEX
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSCIOrdEntXODF_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Atlas.rptSCIOrdEntXODF_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSCIOrdEntXODF_AMEX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSCIOrdEntXODF_AMEX = New rptSCIOrdEntXODF_AMEX()
        rpt.Site = Me.Site
        Return rpt
    End Function
