...
Public Class rptProducciondet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Atlas.rptProducciondet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProducciondet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProducciondet = New rptProducciondet()
        rpt.Site = Me.Site
        Return rpt
    End Function
