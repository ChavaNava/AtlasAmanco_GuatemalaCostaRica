...
Public Class rptSCOrdEntXODF_AMEX
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSCOrdEntXODF_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Atlas.rptSCOrdEntXODF_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSCOrdEntXODF_AMEX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSCOrdEntXODF_AMEX = New rptSCOrdEntXODF_AMEX()
        rpt.Site = Me.Site
        Return rpt
    End Function
