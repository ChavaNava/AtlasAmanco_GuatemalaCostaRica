...
Public Class rptSCOrdEntXProd_AMEX
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSCOrdEntXProd_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Atlas.rptSCOrdEntXProd_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSCOrdEntXProd_AMEX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSCOrdEntXProd_AMEX = New rptSCOrdEntXProd_AMEX()
        rpt.Site = Me.Site
        Return rpt
    End Function
