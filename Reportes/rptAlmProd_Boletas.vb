...
Public Class rptAlmProd_Boletas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Atlas.rptAlmProd_Boletas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAlmProd_Boletas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAlmProd_Boletas = New rptAlmProd_Boletas()
        rpt.Site = Me.Site
        Return rpt
    End Function
