...
Public Class rptPTIOrdEntXODF_AMEX
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPTIOrdEntXODF_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Atlas.rptPTIOrdEntXODF_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPTIOrdEntXODF_AMEX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPTIOrdEntXODF_AMEX = New rptPTIOrdEntXODF_AMEX()
        rpt.Site = Me.Site
        Return rpt
    End Function
