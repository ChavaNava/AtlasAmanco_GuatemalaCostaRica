...
#Region "Eventos"
    Private Sub MenuPTE_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        OperacionExtrusionPeru.SAP_Status("E", tsImagen)
        ' ---------------------------------------------------------------------------------
        'Inicializan fecha Turno y SAP
        OperacionExtrusionPeru.Inicializa_Frm_PTEI(dtpFECHA, dtpFECHASAP, chkSAP)
        ' ---------------------------------------------------------------------------------
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        Cadena = Puertos.SerialPort_1.ReadExisting
        TPC = Chr(CH1)
        TPC2 = Chr(CH2)
    ...
    Private Sub Timer2_Tick(sender As System.Object, e As System.EventArgs) Handles Timer2.Tick
        ...
        Cadena = Puertos.SerialPort_2.ReadExisting
    ...
    Private Sub TSobrePeso_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSobrePeso.TextChanged
        If PorcentajeSobrePeso < (SobrepesoPermitido * -1) Or PorcentajeSobrePeso > SobrepesoPermitido Then
            ...
            TSobrePeso.BackColor = Color.Red
            cmbSobrePesoCausa.Enabled = True
            Catalogo_Causas.CB(cmbSobrePesoCausa, Seccion.Trim, "SP")
        Else
            cmbSobrePesoCausa.DataSource = Nothing
    ...
    Private Sub MenuPTE_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        ...
        LimpiaObjetos()
        OperacionExtrusionPeru.Cerrar(Me.Name, "Cerrar")
    End Sub
    ...
    Private Sub CB_Causa_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbSobrePesoCausa.Leave
        BPesar.Focus()
    End Sub
    ...
    Private Sub CB_Rack_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cmbRack.KeyPress
        If e.KeyChar = ChrW(Keys.Enter) Then
            e.Handled = True
            SendKeys.Send("{TAB}")
        End If
    ...
    Private Sub CB_Rack_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbRack.Leave
        'Determina si es rack Manual
        Catalogo_Racks.Tipo(cmbRack.SelectedValue)
        Select Case Pesos_Rack._Tipo
            Case Is = "M"
            ...
            Case Else
                ...
                Select Case Catalogo_Racks.Peso(cmbRack.SelectedValue)
                    Case Is = True
                        TPesoRack.Text = Pesos_Rack.Peso
                    Case Is = False
                        TPesoRack.Text = Pesos_Rack.Peso
                End Select
        End Select
    ...
    Private Sub CB_Rack_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbRack.Enter
        cmbRack.BackColor = Color.LightSkyBlue
    End Sub
    ...
    Private Sub CB_Causa_KeyPress(sender As System.Object, e As System.Windows.Forms.KeyPressEventArgs) Handles cmbSobrePesoCausa.KeyPress
        If e.KeyChar = ChrW(Keys.Enter) Then
            e.Handled = True
            SendKeys.Send("{TAB}")
        End If
    ...
    Private Sub CB_Causas_KeyPress(sender As System.Object, e As System.Windows.Forms.KeyPressEventArgs) Handles cmbCausaScrap.KeyPress
        If e.KeyChar = ChrW(Keys.Enter) Then
            e.Handled = True
            SendKeys.Send("{TAB}")
        End If
    ...
    '    ''If P_CD = False Then
    '    If cmbCausaScrap.SelectedValue = Nothing Then
    ...
    '            If cmbSPCausa.SelectedValue = Nothing Then
...
#Region "Metodos"
    ...
    Private Sub Notifica_PT()
        ...
        NPTExtrusion.iIdRack = cmbRack.Text.Trim
        ...
        NPTExtrusion.iTipoCausa = cmbSobrePesoCausa.SelectedValue
        ...
        Select Case P_SP
            Case Is = True
                If (PorcentajeSobrePeso < LBP Or PorcentajeSobrePeso > LSP) Then
                    ...
                    '    cmbSPCausa.Enabled = True
                    '    TCausas.Enabled = True
                    '    Catalogo_Causas.Combo_Causas(cmbSPCausa, "", Seccion.Trim, "SP", False)
                    '    TCausas.Focus()
                    '    Return
                    'Else
                    EstatusAutoriza = 2
                    ...
                    Select Case EstatusAutoriza
                        Case Is = 1
                            ...
                            RegistrarSBP.Causa = cmbSobrePesoCausa.SelectedValue
