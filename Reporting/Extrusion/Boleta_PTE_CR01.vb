...
Public Class Boleta_PTE_CR01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.Boleta_PTE_CR01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBoleta_PTE_CR01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Boleta_PTE_CR01 = New Boleta_PTE_CR01()
        rpt.Site = Me.Site
        Return rpt
    End Function
