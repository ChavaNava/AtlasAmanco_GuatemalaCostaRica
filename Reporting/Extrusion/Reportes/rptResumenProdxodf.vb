...
Public Class rptResumenProdxodf
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.rptResumenProdxodf.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenProdxodf
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenProdxodf = New rptResumenProdxodf()
        rpt.Site = Me.Site
        Return rpt
    End Function
