...
Public Class Etiqueta_CR01_SCE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.Etiqueta_CR01_SCE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiqueta_CR01_SCE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Etiqueta_CR01_SCE = New Etiqueta_CR01_SCE()
        rpt.Site = Me.Site
        Return rpt
    End Function
