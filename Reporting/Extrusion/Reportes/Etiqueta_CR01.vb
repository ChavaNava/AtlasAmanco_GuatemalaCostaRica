...
Public Class Etiqueta_CR01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.Etiqueta_CR01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiqueta_CR01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Etiqueta_CR01 = New Etiqueta_CR01()
        rpt.Site = Me.Site
        Return rpt
    End Function
