...
Public Class rptResumenProdxeqp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.rptResumenProdxeqp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenProdxeqp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenProdxeqp = New rptResumenProdxeqp()
        rpt.Site = Me.Site
        Return rpt
    End Function
