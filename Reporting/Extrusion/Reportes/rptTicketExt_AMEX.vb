...
Public Class rptTicketExt_AMEX
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.rptTicketExt_AMEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTicketExt_AMEX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTicketExt_AMEX = New rptTicketExt_AMEX()
        rpt.Site = Me.Site
        Return rpt
    End Function
