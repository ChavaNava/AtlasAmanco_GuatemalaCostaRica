...
Public Class rptPTEOrdEntXODF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.rptPTEOrdEntXODF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPTEOrdEntXODF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPTEOrdEntXODF = New rptPTEOrdEntXODF()
        rpt.Site = Me.Site
        Return rpt
    End Function
