...
Public Class rptPTEOrdEntXProd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.rptPTEOrdEntXProd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPTEOrdEntXProd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPTEOrdEntXProd = New rptPTEOrdEntXProd()
        rpt.Site = Me.Site
        Return rpt
    End Function
