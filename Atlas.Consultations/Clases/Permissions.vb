...
Public Class Permissions
    Public Shared Sub Access(ByVal Modulo As String, ByVal Area As String, ByVal Perfil As String, ByVal Secc As String, Texto_Cabeceras As String, TipoShow As Integer)
        ...
        If (Cnn.LecturaBD_ADM.Read) Then
            ...
            If Form_Atlas <> "NA" Then
                ...
                Else
                    Dim Frm As New Form
                    Dim formName As String = "Atlas.Consultations." & Form_Atlas.Trim
