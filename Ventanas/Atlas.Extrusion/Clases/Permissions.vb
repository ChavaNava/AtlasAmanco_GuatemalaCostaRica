...
Public Class Permissions
    ...
    Public Shared Sub Access(ByVal Modulo As String, ByVal Area As String, ByVal Perfil As String, ByVal Secc As String, Texto_Cabeceras As String)
        ...
        DB.LecturaQry_ADM("PA_Permisos_Usuario '" & SessionUser._sCentro.Trim & "', '" & Modulo.Trim & "', '" & SessionUser._sIdPerfil.Trim & "' ", SessionUser._sAlias.Trim)
        If (DB.LecturaBD_ADM.Read) Then
            ...
            If Form_Atlas <> "NA" Then
                ...
                Else
                    Dim Frm As New Form
                    Dim formName As String = "Atlas.Extrusion." & Form_Atlas.Trim
