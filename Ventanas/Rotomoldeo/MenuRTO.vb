...
#Region "Eventos"
    ...
    Private Sub MenuRTO_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ClaveOperador_Enter(sender As System.Object, e As System.EventArgs) Handles CveOperador.Enter
    ...
    Private Sub Notifica_PT()
        ...
        N_FechaPesaje = Date.Today.ToString("yyyyMMdd")
        ...
        'Se ingresa información de notificacion en la base de datos y se obtiene el folio ------------------------------
        FolioSiguiente = Rotomoldeo.Alta(SessionUser._sAlias.Trim, TC_Orden.Text.Trim, SessionUser._sCentro.Trim, N_Tramos, TPtoTrabajo.Text.Trim, N_FechaPesaje, strNumeroBascula,
                        CB_Rack.Text.Trim, N_PB, N_PT, 0, N_PN, N_CodUser, N_Turno, N_Comp_1, N_Porc_1, N_Cant_1, N_Comp_2, N_Porc_2, N_Cant_2,
                        N_PesoTeorico, 1)
            ...
            Case "True"
                Select Case chkSAP.Checked
                    Case True
                        ...
                        Dim StrCadenas As String = CodOperador.Text.Trim & "|" & FolioSiguiente.Trim
                        Try
                            Label12.Visible = True
                            Label12.Text = "Se esta Notificando la orden '" & TC_Orden.Text.Trim & "' a SAP"
                            NotificationProcess.Notifica_RTO(StrCadenas, FechaPesajeSAP, N_Tramos.ToString, TC_Orden.Text.Trim, N_PN, TNumNoti, TConsNoti, BNotificar, BImprimir, TC_Orden, FolioSiguiente)
        ...
        End Select
        'Consulta cantidades
        ProductionOrder.CalCantRot(SessionUser._sAlias.Trim, SessionUser._sCentro.Trim, TC_Orden.Text.Trim, TCantProgra, TCantEntre, TCantEnproce, TCantPendiente)
        ...
        If TC_Orden.Text <> "" Then
            ...
            Select Case Exist_Ord
                Case Is = 1
                    ...
                    'Consulta cantidades
                    ProductionOrder.CalCant(SessionUser._sAlias.Trim, TC_Orden.Text.Trim, TCantProgra, TCantEntre, TCantEnproce, TCantPendiente, SessionUser._sCentro.Trim)
                    'Porcentaje de avance de la orden
                    ProductionOrder.Porcentaje_Orden(TCantEntre.Text, TCantEnproce.Text, TCantProgra.Text, Label8, Btn_Notificar)
                ...
                Case Is = 0
                    ...
                    ProductionOrder.Inserta_ODF_INY(Orden_Prod.Trim, "T", Me, CodOperador.Text.Trim, EXTINY, SessionUser._sAlias.Trim, _
                                                                  SessionUser._sCentro, SessionUser._sAmbiente, EXTINY, TCodPT, TCodPtDecr, TPtoTrabajo, _
...
#End Region
    ...
    Private Sub Parametrizacion_Forma()
        ...
        If P_VU = True Then
            ...
            Pass_md5 = Crypto.MD5Calculate(SessionUser._sAlias.Trim)
            Gen_Valida.Valida_Usuario(SessionUser._sAlias.Trim, Pass_md5.Trim)
            CodOperador.Text = ""
            NomOperador.Text = ""
