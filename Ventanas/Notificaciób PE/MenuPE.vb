...
#Region "Eventos"
        ...
        If TOrden.Text <> "" Then
            ...
            Select Case Exist_Ord
                ...
                Case Is = 0
                    ...
                    '                                               TPesoTeorico, "0", TCodAnillo, TDAnillo, TGrpprod, TGrupo, TSP_Permitido, _
    ...
    Private Sub TtramosNoti_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TtramosNoti.Leave
        If RB_SC.Checked = False Then
            ...
            If TPesoBruto.Text <> "0.00" Or TPesoTara.Text <> "0.00" Then
                TPesoNeto.Text = Format((TPesoBruto.Text - TPesoTara.Text), xFormato)
            End If
        End If
        CB_Rack.Focus()
    End Sub
