...
Public Class FrmStatusSAPE
    ...
    Private Sub FrmStatusSAPE_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        limpiarCampos()
        TxtClaveE.Focus()
    End Sub
    Sub limpiarCampos()
    ...
    Private Sub TxtClaveE_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtClaveE.Leave
        ...
        If (Me.BtnActE.Enabled = False) Then
            ...
            Q = Q & "And ADM_StatusSAP.Modulo = 'E' "
            ...
            Do While (myDataReader.Read())
                ...
                TxtTurnoE.Text = myDataReader("Turno")
