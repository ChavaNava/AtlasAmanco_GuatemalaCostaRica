...
Public Class FrmModificaSC
    ...
    Private Sub DGV_BP_CurrentCellChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DGV_BP.CurrentCellChanged
        ...
        If oldRowIndex <> -1 Then
            ...
            Try
                ...
                N_CC1 = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(8).Value.ToString
                N_PC1 = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(9).Value.ToString
                N_ConC1 = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(10).Value.ToString
                N_CC2 = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(11).Value.ToString
                N_PC2 = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(12).Value.ToString
                N_ConC2 = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(13).Value.ToString
                N_Bas = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(14).Value.ToString
                N_UsrReg = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(15).Value.ToString
                N_Turno = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(16).Value.ToString
                N_DocSAP = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(17).Value.ToString
                N_ConSAP = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(18).Value.ToString
                N_PtoT = DGV_BP.Rows(DGV_BP.CurrentCell.RowIndex).Cells(19).Value.ToString
    ...
    Public Sub Grid_Load()
        ...
        QRY_Grid = QRY_Grid & "IsNull(b.Compuesto1,0) as Compuesto1,IsNull(b.Porcentaje1,0) as Porcentaje1,"
        QRY_Grid = QRY_Grid & "IsNull(((b.Peso_Neto * b.Porcentaje1)/100),0) as Consumo1,IsNull(b.Compuesto2,0) as Compuesto2,"
        QRY_Grid = QRY_Grid & "IsNull(b.Porcentaje2,0) as Porcentaje2,IsNull(((b.Peso_Neto * b.Porcentaje2)/100),0) as Consumo2,"
        QRY_Grid = QRY_Grid & "b.Bascula,b.Usuario,b.Turno,b.Documento_SAP,b.Consecutivo_SAP,b.PuestoTrabajo "
        ...
        End If
        QRY_Grid = QRY_Grid & "And b.Notifica Not IN ('9', '1') "
        ...
        Try
            ...
            DGV_BP.Columns(2).Visible = False                       'Cantidad de Tramos
            ...
            DGV_BP.Columns(8).HeaderText = "Compuesto 1"            'Codigo compuesto 1
            DGV_BP.Columns(9).HeaderText = "Porcentaje 1"           'Porcentaje consumo compuesto 1
            DGV_BP.Columns(10).HeaderText = "Consumo en kilos"      'Consumo compuesto 1
            DGV_BP.Columns(11).HeaderText = "Compuesto 2"           'Codigo compuesto 2
            DGV_BP.Columns(12).HeaderText = "Porcentaje 2"          'Porcentaje consumo compuesto 2
            DGV_BP.Columns(13).HeaderText = "Consumo en kilos"      'Consumo compuesto 2
            DGV_BP.Columns(14).HeaderText = "Bascula"               'Numero de bascula
            DGV_BP.Columns(15).HeaderText = "Usuario"               'Usuario que registra
            DGV_BP.Columns(16).HeaderText = "Turno"                 'Turno en el que se ingresa la notificacion
            DGV_BP.Columns(17).HeaderText = "Documento SAP"         'Num. Documento SAP
            DGV_BP.Columns(18).HeaderText = "Consecutivo SAP"       'Num. Consecutivo SAP
            DGV_BP.Columns(19).HeaderText = "Puesto de Trabajo"     'Puesto de trabajo
        ...
        QRY = ""
        QRY = "Select IsNull(sum(b.Peso_Bruto),0) as Peso_Bruto,"
        ...
        QRY = ""
        QRY = "Select IsNull(Sum(((b.Peso_Neto * b.Porcentaje1)/100)),0) as CV1 "
        QRY = QRY & "From " & SessionUser._sCentro.Trim & "_OrdenProduccion a, " & SessionUser._sCentro.Trim & "_PesoScrap b, "
        If EXTINY = "1" Then
            QRY = QRY & "ProductoTerminadoExtrusion c, "
        ...
        QRY = ""
        QRY = "Select IsNull(sum(((b.Peso_Neto * b.Porcentaje2)/100)),0) as CV2 "
        QRY = QRY & "From " & SessionUser._sCentro.Trim & "_OrdenProduccion a, " & SessionUser._sCentro.Trim & "_PesoScrap b, "
        If EXTINY = "1" Then
            QRY = QRY & "ProductoTerminadoExtrusion c, "
            QRY = QRY & "CompuestoExtrusion d "
        ...
        QRY = ""
        QRY = "Select IsNull(Sum(((b.Peso_Neto * b.Porcentaje1)/100)),0) as CR1 "
        QRY = QRY & "From " & SessionUser._sCentro.Trim & "_OrdenProduccion a, " & SessionUser._sCentro.Trim & "_PesoScrap b, "
        If EXTINY = "1" Then
            QRY = QRY & "ProductoTerminadoExtrusion c, "
            QRY = QRY & "CompuestoExtrusion d "
        ...
        QRY = ""
        QRY = "Select IsNull(Sum(((b.Peso_Neto * b.Porcentaje2)/100)),0) as CR2 "
        QRY = QRY & "From " & SessionUser._sCentro.Trim & "_OrdenProduccion a, " & SessionUser._sCentro.Trim & "_PesoScrap b, "
        If EXTINY = "1" Then
            QRY = QRY & "ProductoTerminadoExtrusion c, "
            QRY = QRY & "CompuestoExtrusion d "
    ...
    Private Sub FrmModSC_AMEX_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = Util.ApplicationIcon()
        If EXTINY = "1" Then
            Me.Text = "Modificación de Pesaje en Proceso Scrap Extrusión"
        Else
            Me.Text = "Modificación de Pesaje en Proceso Scrap Inyección"
        End If
        Str_FI = DTP_FI.Text.Trim
        Str_FF = DTP_FF.Text.Trim
        LimpiarText(Me)
    ...
    Private Sub FrmModSC_AMEX_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        EXTINY = ""
    End Sub
    ...
    Private Sub TPComp1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TPComp1.TextChanged
        If TPComp1.Text.Trim > 0 Or TPComp1.Text.Trim <> "" Then
            TKC1.Text = FormatNumber(((TPesoNeto.Text * TPComp1.Text) / 100), 3)
        End If
    End Sub
    ...
    Private Sub TPComp2_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TPComp2.TextChanged
        If TPComp2.Text.Trim > 0 Or TPComp2.Text.Trim <> "" Then
            TKC2.Text = FormatNumber(((TPesoNeto.Text * TPComp2.Text) / 100), 3)
        End If
    End Sub
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        InQry = ""
        InQry = "Update " & SessionUser._sCentro.Trim & "_PesoScrap "
