Public Class SessionUser
    ...
    Public Shared _sIdCentro As String
    Public Shared Property sIdCentro() As String
        Get
            Return _sIdCentro
        End Get
        Set(ByVal value As String)
    ...
    Public Shared _sPuesto As Boolean
    Public Shared Property sPuesto() As Boolean
        Get
            Return _sPuesto
        End Get
        Set(ByVal value As Boolean)
