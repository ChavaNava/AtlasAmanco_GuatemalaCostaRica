...
Public Class Catalogo_Compuestos
    Shared Sub CB_Compuesto1(ByVal CB As ComboBox, Tipo As String, TipoProd As String, Estatus As Boolean)
        ...
        If Estatus = True Then
            ...
            Try
                Q = ""
                Q = "PA_Compuestos_Consumo '" & SessionUser._sCentro.Trim & "', '" & OrdenProduccionExiste._IdProducto.Trim & "','" & Tipo.Trim & "', '" & TipoProd.Trim & "' "
                Combo(Q)
    ...
    Public Shared Sub Catalogo_Compuestos(ByVal DataGV As DataGridView, Area As String)
        Dim Q As String
        Dim objDa As SqlDataAdapter
        Dim objDs As DataSet

        Q = ""
        Q = "PA_Compuesto '" & SessionUser._sCentro.Trim & "','','','','', '" & Area & "','','','','',1 "
        Try
            objDa = New SqlDataAdapter(Q, MSI(SessionUser._sAmbiente.Trim))
            objDs = New DataSet
            objDa.Fill(objDs)
    ...
    Public Shared Sub ABC_Compuestos()
        LecturaQry("PA_Compuesto '" & SessionUser._sCentro.Trim & "', '" & Compuestos_ABC._IdCompuesto & "', '" & Compuestos_ABC._Descripcion & "', '" & Compuestos_ABC._UM & "', '" & Compuestos_ABC._Clase & "', '" & Compuestos_ABC._Tipo & "', '" & Compuestos_ABC._Activo & "', '" & Compuestos_ABC._Reprocesado & "', '" & Compuestos_ABC._FechaHora & "', '" & Compuestos_ABC._Usuario & "', '2' ")
    End Sub
