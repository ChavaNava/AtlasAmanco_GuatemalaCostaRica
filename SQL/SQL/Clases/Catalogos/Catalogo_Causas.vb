...
#Region "Metodos"
    ...
    Shared Sub CB(ByVal CB As ComboBox, Area As String, TipoCausa As String)
        Dim NDataSet1 As New DataSet
        Dim Q As String
        Q = ""
        Q = "PA_Causas '" & SessionUser._sCentro.Trim & "','','','" & TipoCausa.Trim & "','" & Area.Trim & "','','','','',1"
        Combo(Q)
        NDataSet1 = DataSetCombo.Copy
        CB.DataSource = NDataSet1.Tables(0)
        CB.DisplayMember = "Causa"
        CB.ValueMember = "IdCausa"
    End Sub
