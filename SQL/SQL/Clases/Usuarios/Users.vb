...
Public Class Users
    Public Shared Sub Valida(ByVal Usr As String, ByVal Cve As String, Centro As String, Usuario As String)
        LecturaQry_ADM("PA_Autentifica_Usuario '" & Usr.Trim & "', '" & Cve.Trim & "', '" & Centro & "'", SessionUser._sAlias)
    ...
    Public Shared Function Login(ByVal Usuario As String, ByVal Password As String, Optional ByVal sso As Boolean = False)
        ...
        Do While (LecturaBD_ADM.Read)
            ...
            SessionUser.sIdCentro = LecturaBD_ADM(13)
        Loop
        Return Contador
    End Function

    Public Shared Function Login_Notifier(ByVal Usuario As String, ByVal Password As String) As Boolean
        LecturaQry_ADM("PA_Login_Notifier '" & SessionUser._sCentro.Trim & "', '" & Password.Trim & "'", SessionUser._sAlias)
    ...
    Public Shared Function Login_Estatus_SAP(ByVal Password As String, Secc As String) As Boolean
        LecturaQry_ADM("PA_Login_Estatus_SAP '" & SessionUser._sCentro & "', '" & Password.Trim & "', '" & Secc.Trim & "'", SessionUser._sAlias)
        If (LecturaBD_ADM.Read) Then
