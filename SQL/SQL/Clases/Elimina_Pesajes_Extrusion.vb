...
Public Class Elimina_Pesajes_Extrusion
    ...
    Public Shared Sub Consulta_PT_SC_Extrusion(ByVal Centro As String, Area As String, Usuario As String, ByVal DataGV As DataGridView, _
        ...
        Q = ""
        Q = "PA_Consulta_Pesajes_Baja '" & Centro.Trim & "', '" & Area.Trim & "', '" & FI.Trim & "', '" & FF.Trim & "', '" & Orden.Trim & "' "
        Try
