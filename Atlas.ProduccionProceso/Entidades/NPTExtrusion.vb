Public Class NPTExtrusion
    ...
    Public Shared _iFolioProduccionProceso As String
    Public Shared Property iFolioProduccionProceso() As String
        Get
            Return _iFolioProduccionProceso
        End Get
        Set(ByVal value As String)
            _iFolioProduccionProceso = value
        End Set
    End Property

    Public Shared _iEstatusProceso As String
    Public Shared Property iEstatusProceso() As String
        Get
            Return _iEstatusProceso
        End Get
        Set(ByVal value As String)
            _iEstatusProceso = value
        End Set
    End Property
    ...
    Public Shared _iPBR As Decimal
    Public Shared Property iPBR() As Decimal
        Get
            Return _iPBR
        End Get
        Set(ByVal value As Decimal)
    ...
    Public Shared _iPTR As String
    Public Shared Property iPTR() As String
        Get
            Return _iPTR
        End Get
        Set(ByVal value As String)
    ...
    Public Shared _iPNR As Decimal
    Public Shared Property iPNR() As Decimal
        Get
            Return _iPNR
        End Get
        Set(ByVal value As Decimal)
    ...
    Public Shared _iTramosR As Integer
    Public Shared Property iTramosR() As Integer
        Get
            Return _iTramosR
        End Get
    ...
    Public Shared _iFolioRecuperacion As String
    Public Shared Property iFolioRecuperacion() As String
        Get
            Return _iFolioRecuperacion
        End Get
        Set(ByVal value As String)
            _iFolioRecuperacion = value
        End Set
    End Property

    Public Shared _iMensajeSAP As String
    Public Shared Property iMensajeSAP() As String
        Get
            Return _iMensajeSAP
        End Get
        Set(ByVal value As String)
    ...
    Public Shared _iDocSAP As String
    Public Shared Property iDocSAP() As String
        Get
            Return _iDocSAP
        End Get
        Set(ByVal value As String)
    ...
    Public Shared _iNumSAP As String
    Public Shared Property iNumSAP() As String
        Get
            Return _iNumSAP
        End Get
        Set(ByVal value As String)
    ...
    Public Shared _iIdReg As Integer
    Public Shared Property iIdReg() As Integer
        Get
            Return _iIdReg
        End Get
        Set(ByVal value As Integer)
