...
Public Class FrmTiemposModifica
...
#Region "Metodos"
    ...
    Private Sub FolioModifica()
        Select Case OperacionTiempos.LeerHorasRegistradas(txtFolio.Text, 6)
            Case Is = True
                FillSetModifica()
                Select Case OperacionTiempos.ValidaHoras(3, cmbTurno.Text, txtOrden.Text, DTP_FI.Value.ToString("yyyy-MM-dd"))
                    Case Is = True
    ...
    End Sub
    Private Sub FillSetModifica()
        DTP_FI.Text = ConsultaHoras._rFecha
        txtOrden.Text = ConsultaHoras._rOrden
        cmbPuestoTrabajo.Text = ConsultaHoras._rIdPuestoTrabajo
        txtPuestoTrabajo.Text = ConsultaHoras._rPuestoTrabajo
        txtIdArea.Text = ConsultaHoras._rGrupProd
        txtArea.Text = ConsultaHoras._rGrupProdDesc
        txtIdSeccion.Text = ConsultaHoras._rCodSeccion
        txtSeccion.Text = ConsultaHoras._rSeccion
        txtIdProducto.Text = ConsultaHoras._rIdProducto
        txtProducto.Text = ConsultaHoras._rProducto
        cmbGpoDiametro.Text = ConsultaHoras._rIdGrupMaterial
        txtGpoDiametro.Text = ConsultaHoras._rGrupMaterial
        cmbGpoCausa.Text = ConsultaHoras._rGrupoParos
        cmbConceptoParo.Text = ConsultaHoras._rConceptoParo
        cmbTurno.Text = ConsultaHoras._rTurno
    End Sub
